...
public class JFGSPopWindow implements PopupWindow.OnDismissListener{
    ...
    private JFGSPopWindow(Context context){
        mContext = context;
    }
    ...
    public JFGSPopWindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public JFGSPopWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public JFGSPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public JFGSPopWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
    ...
    public static class PopupWindowBuilder{
        private JFGSPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new JFGSPopWindow(context);
        }
