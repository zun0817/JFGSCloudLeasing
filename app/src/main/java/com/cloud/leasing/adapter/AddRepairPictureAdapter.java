...
public class AddRepairPictureAdapter extends CommonAdapter<String> {
    ...
    public AddRepairPictureAdapter(Context context, List<String> selectPath, RecyclerView rvImages) {
