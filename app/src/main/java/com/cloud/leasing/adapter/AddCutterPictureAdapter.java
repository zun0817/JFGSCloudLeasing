...
public class AddCutterPictureAdapter extends CommonAdapter<String> {
    ...
    public AddCutterPictureAdapter(Context context, List<String> selectPath, RecyclerView rvImages) {
