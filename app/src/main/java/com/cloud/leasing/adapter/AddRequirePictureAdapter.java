...
public class AddRequirePictureAdapter extends CommonAdapter<String> {
    ...
    public AddRequirePictureAdapter(Context context, List<String> selectPath, RecyclerView rvImages) {
