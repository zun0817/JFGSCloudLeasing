...
public class AddMachinePictureAdapter extends CommonAdapter<String> {
    ...
    public AddMachinePictureAdapter(Context context, List<String> selectPath, RecyclerView rvImages) {
