...
public class AddDevicePictureAdapter extends CommonAdapter<String> {
    ...
    public AddDevicePictureAdapter(Context context, List<String> selectPath, RecyclerView rvImages) {
