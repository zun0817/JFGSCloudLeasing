...
class FaultDataFragment :
    ...
    private fun initView() {
        ...
        viewBinding.faultDataRecycleview.setAdapter(manageDataAdapter)
        viewBinding.faultDataRecycleview.setGroupIndicator(null)
            ...
            manageDataLiveData.observe(viewLifecycleOwner, { it ->
                it.onFailure {
                    ...
                    if (it.size > 0) {
                        ...
                        viewBinding.faultDataRecycleview.expandGroup(0)
                    }
                }
            })
