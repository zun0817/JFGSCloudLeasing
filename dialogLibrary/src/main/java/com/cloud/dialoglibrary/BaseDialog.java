...
public class BaseDialog extends AppCompatDialog {
    ...
    public static final class Builder {
        ...
        public Builder setWidthdp(int val) {
            //width = UiUtils.dip2px(mContext, val);
            width = val;
            return this;
        }

        public Builder setHeightdp(int val) {
            //height = UiUtils.dip2px(mContext, val);
            height = val;
            return this;
        }

        public Builder setWidthDimenRes(int dimenRes) {
            width = UiUtils.getDimens(mContext, dimenRes);
            return this;
        }

        public Builder setHeightDimenRes(int dimenRes) {
            height = UiUtils.getDimens(mContext, dimenRes);
            return this;
        }
